...
Its authenticated native Hand can also bridge a [Flipper Zero over Bluetooth LE](../docs/flipper-zero.md), exposing typed device RPC tools without custom Flipper firmware.
