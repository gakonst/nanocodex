...
final class InboxUITests: XCTestCase {
    ...
    func testMainThreadKeepsIndependentDraftAndProjectNavigation() {
        ...
        XCTAssertTrue(app.buttons["main-thread-entry"].label.contains("Main Thread"))
        ...
        XCTAssertEqual(app.buttons["conversation-title:demo-main-thread"].label, "Main Thread")
