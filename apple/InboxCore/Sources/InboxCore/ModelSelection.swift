...
public struct ModelChoice: Identifiable, Equatable, Sendable {
    ...
    public static let all: [Self] = [
        ...
        .init(id: "gpt-5.6-terra", name: "Terra", efforts: ["none", "low", "medium", "high", "xhigh", "max"]),
    ...
    private static let legacy: [Self] = [
        .init(id: "gpt-5.6-sol", name: "GPT-5.6 Sol", efforts: ["none", "low", "medium", "high", "xhigh", "max"]),
        .init(id: "gpt-5.6-luna", name: "GPT-5.6 Luna", efforts: ["none", "low", "medium", "high", "xhigh", "max"]),
    ]
    public static func find(_ id: String) -> Self? { (all + legacy).first { $0.id == id } }
