...
//! model pages for [Sol](https://developers.openai.com/api/docs/models/gpt-6-sol),
...
//! in output tokens and are not charged a second time. Requests with
