...
export function preflightEnvironment(environment, revision, {
  ...
  return {
    ...
    NANOCODEX_SLACK_OAUTH_CLIENT_ID_CONFIGURED: configured("NANOCODEX_SLACK_OAUTH_CLIENT_ID") ? "true" : "false",
    NANOCODEX_SLACK_OAUTH_CLIENT_SECRET_CONFIGURED: configured("NANOCODEX_SLACK_OAUTH_CLIENT_SECRET") ? "true" : "false",
  };
}
...
export function normalizeDeploymentEnvironment(environment) {
  ...
  const aliases = {
    ...
    NANOCODEX_SLACK_OAUTH_CLIENT_ID: "SLACK_CLIENT_ID",
    NANOCODEX_SLACK_OAUTH_CLIENT_SECRET: "SLACK_CLIENT_SECRET",
  };
