...
# Fail when the browser CDN example or bindings README pin drifts from package.json.
check-browser-cdn:
    ./scripts/check-browser-cdn.sh
...
release-check version:
    ...
    bash -n install scripts/changelog.sh scripts/check-docs.sh scripts/check-browser-cdn.sh scripts/publish-crates.sh
    @for crate in nanocodex-core nanocodex-macros nanocodex-observability nanocodex-service nanocodex-tools nanocodex-mcp nanocodex; do \
