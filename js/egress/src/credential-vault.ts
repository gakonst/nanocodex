...
const DEVELOPMENT_KEY = "MDEyMzQ1Njc4OWFiY2RlZjAxMjM0NTY3ODlhYmNkZWY";
...
export class CredentialVault {
  ...
  constructor(env: CredentialVaultEnv, scope: string) {
    ...
    this.#current = configured || DEVELOPMENT_KEY;
    this.#previous = env.CREDENTIAL_ENCRYPTION_KEY_PREVIOUS?.trim() || undefined;
    this.#scope = ownedBytes(new TextEncoder().encode(`nanocodex/egress-credential/v1/${scope}`));
  }
