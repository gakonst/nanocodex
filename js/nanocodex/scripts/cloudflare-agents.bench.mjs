...
const models=choices('models',['gpt-6-luna','gpt-6-sol','gpt-6-astra']);
...
for(const [selected,allowed] of [[models,['gpt-6-luna','gpt-6-sol','gpt-6-astra']],[efforts,['low','medium','high','xhigh','max']],[tiers,['default','fast']],[paths,['nanocodex_cloudflare','openai_agents','responses_http']]])if(selected.some(x=>!allowed.includes(x))||new Set(selected).size!==selected.length)throw Error('invalid matrix selection');
