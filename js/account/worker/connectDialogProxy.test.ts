...
test("strips the public prefix without exposing canonical credentials", async () => {
  ...
  assert.equal(
    ...
    "frame-ancestors 'self' https://nanocodex.localhost https://*.nanocodex.localhost http://nanocodex.localhost:* http://*.nanocodex.localhost:* https://nanocodex-connect-playground.gakonst.workers.dev chrome-extension://jpkimkgbgbpcaldbnhlhbkbadmpeffle",
  );
