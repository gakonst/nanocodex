const MANAGED_AGENT_SETTINGS_TABLE = `
  CREATE TABLE IF NOT EXISTS managed_agent_settings (
    ...
    model TEXT NOT NULL CHECK (
      model IN ('gpt-6-sol', 'gpt-6-luna', 'gpt-5.6-sol', 'gpt-5.6-terra', 'gpt-5.6-luna', 'gpt-6-astra', '@cf/zai-org/glm-5.3', 'kimi-k3', 'mimo-v2.6-pro')
    ),
...
export function initializeManagedAgentSettingsSchema(
  ...
  if (installed.includes("'gpt-6-sol'") && installed.includes("'gpt-6-luna'") && installed.includes("'kimi-k3'") && installed.includes("'mimo-v2.6-pro'")) return;
