...
export default defineConfig({
  ...
  test: {
    ...
    exclude: ["test/provider-probe-schedule.test.ts", "test/provider-probe-slots.test.ts", "test/provider-telemetry-routing.test.ts", "test/thread-model-routing.test.ts"],
