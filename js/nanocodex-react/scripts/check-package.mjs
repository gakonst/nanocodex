...
assert.equal(typeof agent.projectToolOutput, "function");
assert.equal(typeof agent.formatToolOutput, "function");
assert.equal(typeof agent.generatedOutputUrl, "function");
