...
database recovery task use the current `openai-coding-v10` prompt. The
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| `fix-git` | 1.0 | 54.63s | 48.35s | 47.54s | 0.41s | 8/7 | 34,750/14,908/1,580 |
| `openssl-selfsigned-cert` | 1.0 | 42.95s | 38.57s | 37.74s | 0.52s | 3/2 | 7,251/2,628/1,658 |
