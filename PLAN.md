...
`filter-js-from-html` is the first retained red benchmark. Its Selenium test
initially treated failure to discover the installed Chromium driver on native
arm64 as if no alert had fired. The verifier now exports the installed driver
