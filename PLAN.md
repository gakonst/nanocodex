...
Status: in progress. All twenty-six active public tasks have green low-effort
PTC samples with the current `openai-coding-v13` prompt and passed the latest
full-suite gate together. The table records representative warm samples, and
the latest complete-suite checkpoint is the registry-resolved 26-task gate
described below:
